        ...
        flex hover:shadow-card transition duration-150 ease-in cursor-pointer">  <!-- START OF IDEA CONTAINER -->
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    ...
                    font-bold text-xxs uppercase rounded-xl px-4 py-3">Vote</button>
                </div>
            </div>
                                ...
                                <svg fill="currentColor" width="24" height="6">
                                    <path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0
                                     100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97
                                      2.97 0 10-.003
                                    5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"></svg>
        ...
        flex hover:shadow-card transition duration-150 ease-in cursor-pointer">  <!-- START OF IDEA CONTAINER -->
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    ...
                    transition duration-150 ease-in
                    font-bold text-xxs text-white uppercase rounded-xl px-4 py-3">Voted</button>
                </div>
            </div>
                ...
                <div class="mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            rounded-full text-center w-28 h-7 py-2 px-4">In Progress</div>
